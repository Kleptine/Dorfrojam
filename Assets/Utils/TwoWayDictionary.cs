...
{
    /// <summary>Represents a dictionary with non-null unique values that provides access to an inverse dictionary.</summary>
        ...
        where TValue : notnull
    {
        ...
        /// <summary>Gets the inverse <see cref="TwoWayDictionary{TKey,TValue}" />.</summary>
        ...
        /// <summary>Gets the <see cref="IEqualityComparer{T}" /> that is used to determine equality of values for the dictionary.</summary>
        public IEqualityComparer<TValue> ValueComparer { get; }

        /// <summary>Gets the number of key/value pairs contained in the <see cref="TwoWayDictionary{TKey,TValue}" />.</summary>
        public int Count => _baseDictionary.Count;

        /// <summary>Gets a collection containing the keys in the <see cref="TwoWayDictionary{TKey,TValue}" />.</summary>
        public Dictionary<TKey, TValue>.KeyCollection Keys => _baseDictionary.Keys;

        /// <summary>Gets a collection containing the values in the <see cref="TwoWayDictionary{TKey,TValue}" />.</summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="TwoWayDictionary{TKey,TValue}" /> class that is empty, has the
        ///     default initial capacity, and uses the default equality comparers.
        /// </summary>
        public TwoWayDictionary() : this(new Dictionary<TKey, TValue>())
        {
        }
        ...
        /// </summary>
        /// <param name="capacity">The initial number of elements that <see cref="TwoWayDictionary{TKey,TValue}" /> can contain.</param>
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        public TwoWayDictionary(int capacity) : this(capacity, null, null)
        {
        }

        /// <summary>
        ///     Initializes a new instance of the <see cref="TwoWayDictionary{TKey,TValue}" /> class that contains elements
        ///     copied from the specified <see cref="IDictionary{TKey, TValue}" /> and uses the default equality comparers.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="TwoWayDictionary{TKey,TValue}" /> class that contains elements
        ///     copied from the specified <see cref="IEnumerable{T}" /> and uses the default equality comparers.
        /// </summary>
        ...
        /// </param>
        /// <exception cref="ArgumentNullException"></exception>
        public TwoWayDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection)
        ...
        ///     The <see cref="IEqualityComparer{T}" /> implementation to use when comparing keys, or null to
        ///     use the default <see cref="IEqualityComparer{T}" /> for the type of the key.
        /// </param>
        /// <param name="valueComparer">
        ///     The <see cref="IEqualityComparer{T}" /> implementation to use when comparing values, or
        ///     null to use the default <see cref="IEqualityComparer{T}" /> for the type of the value.
        /// </param>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="TwoWayDictionary{TKey,TValue}" /> class that is empty, has the
        ///     specified initial capacity, and uses the specified equality comparers.
        /// </summary>
        /// <param name="capacity">The initial number of elements that <see cref="TwoWayDictionary{TKey,TValue}" /> can contain.</param>
        /// <param name="keyComparer">
        ///     The <see cref="IEqualityComparer{T}" /> implementation to use when comparing keys, or null to
        ...
        private TwoWayDictionary(TwoWayDictionary<TValue, TKey> inverse)
        {
            _baseDictionary =
                inverse._baseDictionary.ToDictionary(pair => pair.Value, pair => pair.Key, inverse.ValueComparer);
            ValueComparer = inverse.KeyComparer;
            Inverse = inverse;
        }

        private TwoWayDictionary(Dictionary<TKey, TValue> dictionary, IEqualityComparer<TValue>? valueComparer = null)
        {
        ...
        /// <summary>Removes the value with the specified key from the <see cref="TwoWayDictionary{TKey,TValue}" />.</summary>
        /// <param name="key">The key of the element to remove.</param>
        /// <returns>
        ///     <see langword="true" /> if the element is successfully found and removed; otherwise, <see langword="false" />.
        ///     This method returns <see langword="false" /> if key is not found in the
        ///     <see cref="TwoWayDictionary{TKey,TValue}" />.
        /// </returns>
        /// <exception cref="ArgumentNullException"></exception>
        ...
        /// <summary>Removes all keys and values from the <see cref="TwoWayDictionary{TKey,TValue}" />.</summary>
        public void Clear()
        {
        ...
        /// <summary>Determines whether the <see cref="TwoWayDictionary{TKey,TValue}" /> contains the specified key.</summary>
        /// <param name="key">The key to locate in the <see cref="TwoWayDictionary{TKey,TValue}" />.</param>
        /// <returns>
        ///     <see langword="true" /> if the <see cref="TwoWayDictionary{TKey,TValue}" /> contains an element with the
        ///     specified key; otherwise, <see langword="false" />.
        /// </returns>
        public bool ContainsKey(TKey key) => _baseDictionary.ContainsKey(key);

        /// <summary>Determines whether the <see cref="TwoWayDictionary{TKey,TValue}" /> contains the specified value.</summary>
        /// <param name="value">The value to locate in the <see cref="TwoWayDictionary{TKey,TValue}" />.</param>
        /// <returns>
        ///     <see langword="true" /> if the <see cref="TwoWayDictionary{TKey,TValue}" /> contains an element with the
        ...
        /// <summary>Attempts to add the specified key and value to the <see cref="TwoWayDictionary{TKey,TValue}" />.</summary>
        /// <param name="key">The key of the element to add.</param>
        /// <param name="value">The value of the element to add.</param>
        /// <returns>
        ///     <see langword="true" /> if the key/value pair was added to the <see cref="TwoWayDictionary{TKey,TValue}" />
